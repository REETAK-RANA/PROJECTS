...
<head>
    ...
    <style>
        ...
        /* Make Usage Estimate panel wider */
        .panel:nth-child(1) {
            flex: 2 1 640px;  /* Grow factor 2, min-width 640px */
        }
        /* Make Active Appliances panel smaller */
        .panel:nth-child(2) {
            flex: 1 1 320px;  /* Grow factor 1, min-width 320px */
        }
...
# Email server configuration for Gmail SMTP
smtp_server = "smtp.gmail.com"
port = 587  # TLS port
sender_email = "rajputpraful791@gmail.com"
receiver_email = "reetakrana65@gmail.com"
password = "tehj edww iiqu cwgy"  # Use your actual Gmail app password
